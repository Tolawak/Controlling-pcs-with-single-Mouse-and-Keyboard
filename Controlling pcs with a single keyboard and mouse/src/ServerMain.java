...
public class ServerMain {
    ...
    public static void main(String[] args){
        ...
        String ip = JOptionPane.showInputDialog(" ENTER SERVERRR IP ");
        String port = JOptionPane.showInputDialog("ENTER SERVERRR port NUMBER");
        new ServerMain().initialize(ip, Integer.parseInt(port));
    }
